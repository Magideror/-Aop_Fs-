...
@app.on_message(command(["pause", f"pause@{BOT_USERNAME}", "ps", f"{NAME_BOT} وقف", f"{NAME_BOT} وقفي", "وقف"]))
...
@app.on_message(command(["resume", f"resume@{BOT_USERNAME}", "rs", "كمل", f"كمل@{BOT_USERNAME}", f"{NAME_BOT} كملي", f"{NAME_BOT} كمل"]))
async def stop_cmd(_, message): 
    if message.sender_chat:
        return await message.reply_text("Kamu adalah __Admin Anonim__!\nKembalikan ke Akun Pengguna.") 
    permission = "can_manage_voice_chats"
...
@app.on_message(command(["end", f"end@{BOT_USERNAME}", "e", f"{NAME_BOT} اطلعي", f"{NAME_BOT} ايقاف", f"{NAME_BOT} انهاء", "ايقاف", "انهاء"]))
async def stop_cmd(_, message): 
    if message.sender_chat:
        return await message.reply_text("Kamu adalah __Admin Anonim__!\nKembalikan ke Akun Pengguna.") 
    permission = "can_manage_voice_chats"
...
@app.on_message(command(["skip", f"skip@{BOT_USERNAME}", "sk", "تخطي", f"{NAME_BOT} تخطي"]))
async def stop_cmd(_, message): 
    if message.sender_chat:
        return await message.reply_text("Kamu adalah __Admin Anonim__!\nKembalikan ke Akun Pengguna.") 
    permission = "can_manage_voice_chats"
